...
namespace Hatzap.Utilities
{
    /*	 
	 * 
	 * Tämä on copypaste MonoGamen BoundingFrustum luokasta, joka on MIT eli sillä voi käytännössä tehdä mitä huvittaa
	 * 
	 * */



    public class BoundingFrustum : IEquatable<BoundingFrustum>, IBounder
    {
