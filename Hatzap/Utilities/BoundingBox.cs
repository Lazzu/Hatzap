...
namespace Hatzap.Utilities
{
    /* 
	 * 
	 * Tämä on copypaste MonoGamen BoundingBox luokasta, joka on MIT eli sillä voi käytännössä tehdä mitä huvittaa
	 * 
	 * */



    public class BoundingBox : IEquatable<BoundingBox>, IBounder
    {
