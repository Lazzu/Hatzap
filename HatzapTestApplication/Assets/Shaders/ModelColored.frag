...
uniform vec4 Color = vec4(0.8, 0.8, 0.8, 1);
...
void main( void )
{
	...
	front = phong_blinn(lightFront, n, eye, material);
	//top = phong_blinn(lightTop, n, eye, material);
	//side = phong_blinn(lightSide, n, eye, material);
